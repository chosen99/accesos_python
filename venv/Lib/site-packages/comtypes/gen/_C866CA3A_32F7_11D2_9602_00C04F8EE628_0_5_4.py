...
__all__ = [
    'DISPID_SpeechVoiceEvent', 'ISpProperties',
    'SAFTADPCM_22kHzStereo', 'SPSNoun', 'SPINTERFERENCE_TOOSLOW',
    'SECFIgnoreKanaType', 'SPCATEGORYTYPE',
    'DISPID_SRRTOffsetFromStart', 'SBONone', 'SVSFIsXML',
    'SGRSTTWord', 'DISPID_SRCEInterference',
    ...
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTADPCM_8kHzStereo',
    'SSFMOpenForRead', 'SpeechBookmarkOptions', 'ISpPhoneConverter',
    'SPSSuppressWord', 'SLODynamic', 'DISPID_SRStatus',
    ...
    'DISPID_SASNonBlockingIO', 'SPPS_Unknown',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVSFlagsAsync', 'DISPID_SRCPause',
    'IStream', 'ISpStream', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechPhraseProperties',
    'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_21', 'SINoSignal',
    'DISPID_SPPsItem', 'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRGetFormat', 'SRSActive', 'SAFTGSM610_8kHzMono',
    'DISPID_SRRGetXMLResult', 'DISPID_SASFreeBufferSpace',
    'STSF_CommonAppData', 'SpeechInterference', 'SRAONone',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVPause', 'SRESoundStart',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCEStartStream',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRAudioInputStream', 'SPCT_SLEEP', 'SpeechMicTraining',
    'ISpeechAudioBufferInfo', 'DISPID_SRCESoundEnd',
    'DISPID_SRCERecognizerStateChange', 'SPWAVEFORMATTYPE',
    'LONG_PTR', 'SVP_13', 'SpeechPropertyLowConfidenceThreshold',
    'SVSFParseAutodetect', 'SAFTADPCM_11kHzMono', 'SAFTText',
    'DISPID_SRAudioInput', 'DISPID_SPARecoResult',
    'DISPID_SRRSpeakAudio', 'DISPID_SPIGrammarId', 'SSFMCreate',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechPhraseElements',
    'ISpXMLRecoResult', 'IEnumString', 'SAFT16kHz16BitMono',
    'DISPID_SRCRequestedUIType', 'SPWORDPRONUNCIATIONLIST',
    'ISpNotifySource', 'SpeechFormatType', 'SPINTERFERENCE_NOISE',
    'DISPID_SPAPhraseInfo', 'DISPID_SPIAudioStreamPosition',
    'SRAInterpreter', 'SREStreamEnd', 'SPEI_HYPOTHESIS',
    'ISpeechGrammarRuleStateTransitions', 'SPADAPTATIONRELEVANCE',
    'SGRSTTDictation', 'DISPID_SRSAudioStatus', 'DISPID_SPIStartTime',
    'DISPID_SGRClear', 'SP_VISEME_8', 'ISpeechObjectTokens',
    'DISPID_SGRAttributes', 'SPFM_OPEN_READONLY', 'SPRST_NUM_STATES',
    'eLEXTYPE_PRIVATE20', 'SAFTNonStandardFormat',
    'SpeechDiscardType', 'DISPID_SRProfile',
    'ISpeechGrammarRuleState', 'DISPID_SpeechPhraseAlternate',
    'SASPause', 'DISPID_SGRSTText', 'DISPID_SOTGetAttribute',
    'eLEXTYPE_RESERVED4', 'SpPhraseInfoBuilder',
    'DISPID_SpeechPhraseRule', 'DISPID_SRGRules', 'SpMMAudioIn',
    'SVP_3', 'ISpeechPhraseRules', 'SPEI_RESERVED1',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPDKL_LocalMachine',
    'DISPID_SRCEEndStream', 'SGSExclusive', 'SPPS_Function',
    'SPEI_INTERFERENCE', 'SPEI_SR_BOOKMARK', 'STSF_AppData',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SVWaitUntilDone',
    'STCLocalServer', 'DISPID_SMSAMMHandle', 'SVSFNLPMask',
    'SRTStandard', 'SP_VISEME_6', 'DISPID_SLPSymbolic',
    'DISPID_SPIAudioSizeBytes', 'SPEI_FALSE_RECOGNITION',
    'SPEI_SENTENCE_BOUNDARY', 'SPGS_DISABLED', 'SAFT22kHz8BitMono',
    'DISPID_SOTsCount', 'SpeechPropertyResponseSpeed',
    'ISpRecognizer3', 'DISPID_SRGDictationLoad', 'SPBOOKMARKOPTIONS',
    'DISPID_SLWType', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechObjectTokenCategory', 'DISPIDSPTSI_SelectionOffset',
    'SP_VISEME_0', 'SVEPhoneme', 'SPSVerb', 'SPPROPERTYINFO',
    'SGDSActive', 'DISPID_SVSkip', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPILanguageId', 'SpeechPropertyHighConfidenceThreshold',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SAEventHandle',
    'SDTLexicalForm', 'DISPID_SpeechRecoResultTimes',
    'SPPHRASEPROPERTY', 'SECNormalConfidence',
    'DISPID_SRCEPropertyStringChange', 'SPDKL_CurrentConfig',
    'DISPID_SLWWord', 'STCAll', 'DISPID_SPPs_NewEnum',
    'DISPID_SLPType', 'DISPID_SGRSTsItem', 'SWTDeleted', 'SRADynamic',
    'DISPID_SAFSetWaveFormatEx', 'eLEXTYPE_PRIVATE10', 'DISPID_SRGId',
    'DISPID_SVEventInterests', 'SpeechWordPronounceable',
    'ISpeechGrammarRules', 'DISPID_SOTs_NewEnum', 'DISPID_SGRId',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT32kHz8BitStereo',
    'DISPID_SAVolume', 'ISpRecognizer2', '_ISpeechVoiceEvents',
    'SPWF_INPUT', 'SPEI_PROPERTY_NUM_CHANGE', 'SDKLCurrentUser',
    'DISPID_SRRGetXMLErrorInfo', 'SpLexicon', 'DISPID_SRGCommit',
    'SVP_0', 'DISPID_SVSCurrentStreamNumber',
    'SpeechRetainedAudioOptions', 'DISPID_SPERetainedStreamOffset',
    'SVPNormal', 'SVP_6', 'DISPID_SRState', 'SPAS_CLOSED',
    'DISPID_SADefaultFormat', 'SPEI_SOUND_START',
    'DISPID_SPERequiredConfidence',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLRemovePronunciation', 'SVP_9', 'SECFIgnoreCase',
    'SAFT12kHz8BitStereo', 'SPCT_SUB_COMMAND', 'DISPID_SPPsCount',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechLexiconPronunciation', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpResourceManager', 'DISPID_SPIProperties', 'DISPID_SLPsItem',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCRecognizer',
    'SP_VISEME_15', 'SAFT24kHz8BitMono', 'DISPID_SVSLastResult',
    'SECLowConfidence', 'DISPID_SLGetWords', 'SREAudioLevel',
    'ISpeechAudio', 'SVP_1', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCBookmark', 'SDKLCurrentConfig', 'SpMMAudioEnum',
    'SRARoot', 'DISPID_SRCERecognitionForOtherContext', 'SVP_2',
    'SPWORDTYPE', 'Speech_Max_Pron_Length', 'DISPID_SRCERecognition',
    'SVP_21', 'DISPID_SPAStartElementInResult', 'SAFT22kHz8BitStereo',
    ...
    'DISPID_SAFType', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPEAudioSizeTime', 'eWORDTYPE_DELETED', 'ISpDataKey',
    'ISpVoice', 'DISPID_SpeechPhraseBuilder', 'SpeechGrammarState',
    'SP_VISEME_9', 'SVP_17', 'ISpPhraseAlt', 'DISPID_SPIReplacements',
    'SGPronounciation', 'SAFTGSM610_22kHzMono', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCERequestUI', 'DISPID_SRRRecoContext',
    'DISPID_SRRTTickCount', 'eLEXTYPE_PRIVATE11',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechDataKey',
    'DISPID_SOTRemove', 'DISPID_SGRSTType', 'DISPID_SpeechDataKey',
    'DISPID_SLWLangId', 'SP_VISEME_12', 'SAFT16kHz16BitStereo',
    'SpeechStreamSeekPositionType', 'DISPID_SVGetAudioOutputs',
    'SAFTCCITT_ALaw_11kHzMono', 'SPCS_ENABLED', 'SPRULESTATE',
    'SLTUser', 'SpInProcRecoContext', 'DISPID_SLWPronunciations',
    'SPFILEMODE', 'DISPID_SpeechObjectTokenCategory', 'SPPS_Modifier',
    'SPEI_MAX_TTS', 'DISPID_SVAudioOutputStream',
    'DISPID_SVSInputSentenceLength', 'SAFTGSM610_44kHzMono',
    'DISPID_SWFEChannels', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechPhraseProperties', 'SECFNoSpecialChars',
    'DISPID_SGRInitialState', 'SPSMF_UPS',
    'DISPID_SLGetGenerationChange', 'DISPID_SBSSeek',
    'DISPID_SPISaveToMemory', 'SRESoundEnd', 'SPRECOCONTEXTSTATUS',
    'DISPID_SGRsAdd', 'DISPID_SGRAddState', 'DISPID_SOTCDefault',
    'DISPID_SRCreateRecoContext', 'DISPID_SBSWrite', 'SPWT_DISPLAY',
    'DISPID_SDKEnumValues', 'SpeechTokenKeyAttributes', 'SVP_18',
    'SVESentenceBoundary', 'SpeechCategoryRecognizers',
    'SpSharedRecoContext', '_RemotableHandle', 'ISpeechXMLRecoResult',
    'SPPHRASEELEMENT', 'SAFT12kHz8BitMono', 'DISPID_SOTSetId',
    'ISpeechRecoGrammar', 'DISPID_SRRPhraseInfo', 'DISPID_SVSpeak',
    'DISPID_SBSRead', 'DISPID_SWFEExtraData', 'SPPARTOFSPEECH',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SpeechRecoContext',
    'SPBO_AHEAD', 'SRCS_Disabled', 'SDTProperty',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCESoundStart',
    'SDTDisplayText', 'SRAImport', 'SPEI_RESERVED2',
    'SAFTCCITT_ALaw_22kHzMono', 'SPDATAKEYLOCATION',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechLexiconProns',
    'SREFalseRecognition', 'DISPID_SpeechFileStream',
    'DISPID_SRCRetainedAudio', 'SPSModifier', 'SREPropertyNumChange',
    'SAFT8kHz16BitMono', 'DISPID_SVResume', 'SpeechRunState',
    'DISPID_SABIMinNotification', 'SPEI_PHRASE_START',
    'SRERecoOtherContext', 'DISPID_SDKGetStringValue',
    'SAFT44kHz16BitStereo', 'DISPID_SPCLangId', 'SPWT_LEXICAL',
    'SpeechTokenValueCLSID', 'SpeechLoadOption',
    'ISpeechPhraseElements', 'SASStop', 'SpeechUserTraining',
    'SPSNotOverriden', 'SVEAudioLevel', 'SDTAlternates',
    'SECFDefault', 'SPFM_CREATE_ALWAYS', 'SPEI_START_INPUT_STREAM',
    'SVP_10', 'DISPID_SRGDictationUnload', 'SECFEmulateResult',
    'SP_VISEME_7', 'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseRules',
    'DISPID_SRCVoice', 'ISpObjectToken', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SLWsCount', 'DISPID_SPRFirstElement',
    'SAFT12kHz16BitStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'SGRSTTWildcard', 'ISpLexicon', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPVPRI_NORMAL', 'DISPID_SRGetPropertyString',
    'DISPID_SRCEEnginePrivate', 'SPPS_RESERVED4', 'SFTInput',
    'SpFileStream', 'SPEI_RECO_STATE_CHANGE', 'ISpRecoResult',
    'SAFT8kHz8BitMono', 'SPSHORTCUTTYPE', 'SPEI_MIN_TTS',
    ...
    'DISPID_SRGState', 'SpInprocRecognizer', 'SPWORDPRONOUNCEABLE',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_RESERVED9',
    'STCInprocServer', 'ISpStreamFormatConverter',
    'SpUnCompressedLexicon', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPPS_LMA', 'DISPID_SPPId', 'SAFTDefault', 'ISpPhrase',
    'SSSPTRelativeToStart', 'DISPID_SVSLastBookmark',
    'DISPID_SPPName', 'SpeechTokenContext', 'SpeechDataKeyLocation',
    'SAFTCCITT_ALaw_8kHzMono', 'SPAO_RETAIN_AUDIO',
    'SpPhoneConverter', 'DISPID_SRRTLength', 'DISPID_SVSPhonemeId',
    'SAFT16kHz8BitStereo', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SLWs_NewEnum',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SREPropertyStringChange', 'SPPHRASERULE',
    'ISpeechPhraseProperty', 'SREBookmark', 'eLEXTYPE_PRIVATE2',
    'SPEI_TTS_PRIVATE', 'DISPID_SPRsItem', 'DISPID_SRRTStreamTime',
    'DISPID_SDKSetLongValue', 'SGSEnabled', 'SVF_Stressed', 'SVP_14',
    'ISpeechPhraseRule', 'ISpRecoCategory',
    'SpeechPropertyResourceUsage', 'ISpeechLexiconWords',
    'SPSERIALIZEDRESULT', 'SpCompressedLexicon',
    'DISPID_SOTDisplayUI', 'SVSFIsNotXML', 'DISPID_SPAsCount',
    'DISPID_SPEsCount', 'ISpeechAudioFormat',
    'DISPID_SRCEPhraseStart', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechAudioStatus', 'SpeechVisemeType',
    'DISPID_SASCurrentDevicePosition', 'SVSFPurgeBeforeSpeak',
    'DISPID_SVSpeakCompleteEvent', 'SVP_4', 'ISpObjectTokenCategory',
    'SRSInactiveWithPurge', 'SpNotifyTranslator', 'SITooFast',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpGrammarBuilder',
    'DISPID_SpeechWaveFormatEx', 'ISpRecoContext',
    'DISPID_SRIsShared', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRGDictationSetState', 'DISPID_SASState', 'SPLO_STATIC',
    ...
    'SAFT11kHz8BitStereo', 'SPAR_Unknown',
    'SpeechPropertyAdaptationOn', 'IEnumSpObjectTokens',
    'DISPID_SAFGuid', 'SPAS_RUN', 'SPGRAMMARSTATE', 'SP_VISEME_14',
    'SPEVENT', 'SVEBookmark', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SLGetPronunciations', 'DISPID_SPRuleParent', 'SRSEDone',
    'eLEXTYPE_PRIVATE16', 'ISpRecoGrammar', 'SVP_19', 'SPSFunction',
    'DISPID_SGRSTsCount', 'DISPID_SGRSTransitions',
    'DISPID_SABufferNotifySize', 'DISPID_SRIsUISupported', 'SVP_5',
    'DISPID_SPRuleId', 'SPLO_DYNAMIC', 'DISPID_SpeechPhoneConverter',
    ...
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_PRIVATE8', 'SVP_15',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SFSOpen',
    'tagSTATSTG', 'SDTAudio', 'SPAS_PAUSE', 'ISpStreamFormat',
    'DISPID_SRCState', 'SAFTCCITT_uLaw_22kHzMono', 'SVEPrivate',
    'SINoise', 'DISPID_SRRDiscardResultInfo', 'DISPID_SRGReset',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_USER', 'SGDSActiveWithAutoPause',
    'SPSUnknown', 'SVEEndInputStream', 'DISPID_SPAsItem',
    'DISPID_SOTCId', 'SREStateChange', 'DISPID_SRRAudio',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPPParent',
    'SDKLDefaultLocation', 'SVSFDefault', 'SPSHT_Unknown',
    'SVEVoiceChange', 'DISPID_SLAddPronunciation', 'SPSInterjection',
    'DISPID_SpeechRecoResult2', 'ISpeechPhraseInfoBuilder',
    'SLOStatic', 'SpCustomStream', 'SPCT_DICTATION',
    'ISpeechGrammarRule', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCEventInterests', 'DISPID_SVDisplayUI',
    'IInternetSecurityManager', 'DISPID_SAStatus',
    'DISPID_SRGRecoContext', 'SGRSTTRule', 'SDKLLocalMachine',
    'SPWORDLIST', 'DISPID_SABIBufferSize', 'SPEVENTENUM',
    'DISPID_SPPConfidence', 'ISpeechGrammarRuleStateTransition',
    'eLEXTYPE_APP', 'DISPID_SpeechAudioBufferInfo',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRuleName',
    'SP_VISEME_18', 'DISPID_SpeechLexicon', 'SPSTREAMFORMATTYPE',
    'SAFT11kHz16BitStereo', 'DISPID_SVEViseme',
    'SpeechRecognitionType', 'SDTReplacement', 'DISPID_SABufferInfo',
    'DISPID_SOTDataKey', 'SpeechRegistryUserRoot',
    'DISPID_SDKEnumKeys', 'SGLexical', 'DISPID_SpeechObjectTokens',
    'DISPID_SRCEHypothesis', '_SPAUDIOSTATE', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEAudioLevel', 'SpSharedRecognizer',
    'SpeechAudioFormatGUIDWave', 'SpeechAudioVolume',
    'SpeechGrammarTagDictation', 'DISPID_SAFGetWaveFormatEx',
    'SPEI_SR_AUDIO_LEVEL', 'WAVEFORMATEX', 'SECFIgnoreWidth',
    'SGDSActiveUserDelimited', 'SPPHRASEREPLACEMENT', 'SREAdaptation',
    'SpeechCategoryVoices', 'DISPID_SpeechPhraseInfo', 'SPVPRI_OVER',
    'DISPID_SVSInputSentencePosition', 'SAFT24kHz16BitMono',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_START_SR_STREAM',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechPhraseReplacements',
    'SPLEXICONTYPE', 'SPINTERFERENCE', 'SDTPronunciation',
    'DISPID_SRCCreateGrammar', 'DISPID_SPRNumberOfElements',
    'SpeechLexiconType', 'ISpeechMemoryStream', 'SSTTTextBuffer',
    'SPPS_SuppressWord', 'SPINTERFERENCE_NOSIGNAL',
    'ISequentialStream', 'SRERequestUI', 'SITooLoud',
    'DISPID_SVEStreamEnd', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_PRIVATE4', 'SpeechTokenShellFolder',
    'DISPID_SMSGetData', 'SGDSInactive', 'DISPID_SGRsCommit',
    'SPFM_CREATE', 'SpeechRecoContextState', 'SPPS_RESERVED1',
    'SWPKnownWordPronounceable', 'SAFT8kHz16BitStereo',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRSAddWordTransition',
    'SpeechCategoryRecoProfiles', 'SpeechDisplayAttributes', 'SVP_11',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPRulesCount',
    'SSFMOpenReadWrite', 'SFTSREngine', 'IInternetSecurityMgrSite',
    'SpeechVoicePriority', 'SpeechStreamFileMode',
    'DISPID_SDKGetBinaryValue', 'SSSPTRelativeToEnd',
    'SPSMF_SAPI_PROPERTIES', 'eLEXTYPE_PRIVATE14',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVAudioOutput',
    'DISPID_SPRuleFirstElement', 'SRTReSent', 'DISPID_SVEBookmark',
    'DISPIDSPRG', 'DISPID_SMSSetData', 'DISPID_SVVoice',
    'SPEI_END_SR_STREAM', 'ISpeechRecoResultTimes',
    'STSF_LocalAppData', 'SPPS_RESERVED3', 'SPAR_High',
    ...
    'SAFT48kHz8BitMono', 'SAFT44kHz8BitStereo', 'SPSHORTCUTPAIR',
    'SGRSTTEpsilon', 'DISPID_SpeechPhraseProperty', 'SRTSMLTimeout',
    'SpeechCategoryAudioOut', 'SVP_16',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPAR_Low',
    'DISPID_SpeechVoiceStatus', 'ISpeechRecoResultDispatch',
    'SpeechRegistryLocalMachineRoot', 'SPGS_ENABLED',
    'DISPID_SpeechXMLRecoResult', 'SPCT_COMMAND',
    'ISpeechObjectToken', 'DISPID_SRSClsidEngine',
    'DISPID_SREmulateRecognition', 'ISpeechRecoResult', 'SREPrivate',
    'SPXRO_SML', 'SpeechRuleAttributes', 'SPBO_NONE', 'SPCS_DISABLED',
    'SP_VISEME_19', 'DISPID_SRCResume', 'SP_VISEME_10',
    'DISPID_SOTsItem', 'DISPID_SPAs_NewEnum', 'DISPID_SPEsItem',
    'DISPID_SRRTimes', 'DISPID_SRRecognizer', 'SPRST_ACTIVE',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRSetTextFeedback',
    'DISPID_SOTId', 'SECHighConfidence', 'SPSEMANTICERRORINFO',
    'SPAUDIOSTATE', 'DISPID_SPEDisplayText',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SBSFormat', 'SPAUDIOBUFFERINFO', 'DISPID_SVSRunningState',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPValue', 'SRATopLevel',
    'ISpeechLexiconPronunciation', 'SPEI_VISEME',
    'DISPID_SPERetainedSizeBytes', 'SpeechEngineConfidence',
    'DISPID_SPRuleChildren', 'SPPHRASE', 'SPSHORTCUTPAIRLIST',
    'SpObjectTokenCategory', 'DISPID_SLGenerationId',
    'ISpeechWaveFormatEx', 'SpeechSpecialTransitionType',
    'DISPID_SVSVisemeId', 'SPTEXTSELECTIONINFO', 'SLTApp',
    'SAFTNoAssignedFormat', 'SRAExport', 'SpShortcut',
    'DISPID_SVEVoiceChange', 'DISPID_SRCEFalseRecognition', 'SVP_12',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVGetVoices',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SGLexicalNoSpecialChars',
    'ISpEventSink', 'SRTAutopause', 'SDTRule', 'SREHypothesis',
    'DISPID_SVSLastBookmarkId', 'SPGRAMMARWORDTYPE',
    'ISpeechLexiconWord', 'SPAUDIOOPTIONS',
    'DISPID_SRCCreateResultFromMemory', 'SP_VISEME_3', 'SpStream',
    'SPRS_INACTIVE', 'DISPID_SRSCurrentStreamNumber',
    'SAFTADPCM_22kHzMono', 'SDA_No_Trailing_Space',
    'ISpeechPhoneConverter', 'SAFT22kHz16BitStereo', 'ISpEventSource',
    'DISPID_SRSetPropertyNumber', 'SpeechWordType',
    'ISpeechCustomStream', 'SPVOICESTATUS',
    'DISPID_SRSetPropertyString', 'DISPID_SPEs_NewEnum',
    'SPWF_SRENGINE', 'DISPID_SPRules_NewEnum', 'DISPID_SPPChildren',
    'DISPID_SPIGetText', 'SpeechRecognizerState',
    'DISPID_SPPEngineConfidence', 'SREInterference',
    'SRADefaultToActive', 'DISPID_SOTCGetDataKey',
    'DISPID_SPEAudioStreamOffset', 'SP_VISEME_2', 'SPEI_ADAPTATION',
    'DISPID_SPRText', 'SpResourceManager', 'DISPID_SGRName',
    'DISPID_SGRsItem', 'SVPOver', 'SpeechTokenIdUserLexicon',
    'SVF_Emphasis', 'DISPID_SVSInputWordLength', 'SDTAll',
    'DISPID_SPEDisplayAttributes', 'SPXMLRESULTOPTIONS',
    'DISPID_SDKOpenKey', 'SREStreamStart',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRCEBookmark',
    'SPSHT_OTHER', 'SPDKL_DefaultLocation', 'ISpeechFileStream',
    'DISPID_SPEActualConfidence', 'DISPID_SDKDeleteValue',
    'SP_VISEME_4', 'SPBO_PAUSE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    ...
    'SAFT12kHz16BitMono', 'SAFT24kHz8BitStereo', 'SPRECOSTATE',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechVoice', 'SAFT22kHz16BitMono',
    'DISPID_SPRsCount', 'SVSFPersistXML',
    'DISPID_SOTMatchesAttributes', 'SpeechCategoryAppLexicons',
    'DISPID_SVVolume', 'ISpeechRecoContext', 'SPINTERFERENCE_NONE',
    'SRTEmulated', 'SP_VISEME_1', 'DISPID_SpeechMemoryStream',
    'SVSFParseSapi', 'DISPID_SRGetRecognizers',
    'DISPID_SPELexicalForm', 'SBOPause', 'SRSInactive',
    'SP_VISEME_11', 'SREAllEvents', 'SpeechAudioProperties',
    'SpeechRecoEvents', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpPhoneticAlphabetSelection', 'DISPID_SFSClose',
    'ISpeechRecognizer', 'SPRST_INACTIVE', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SGRSTPropertyValue', 'DISPID_SGRsFindRule',
    'DISPID_SPIRule', 'SVPAlert', 'ISpRecoContext2',
    'STSF_FlagCreate', 'ISpeechPhraseAlternates', 'SRSActiveAlways',
    'SpeechVoiceSkipTypeSentence', 'ISpSerializeState',
    'DISPID_SRGCmdLoadFromObject', 'SpAudioFormat',
    'SPXRO_Alternates_SML', 'SpeechVoiceEvents', 'DISPID_SMSALineId',
    'DISPID_SPRulesItem', 'SPBO_TIME_UNITS', 'ISpeechLexicon',
    'DISPID_SpeechGrammarRuleState', 'SPRULE',
    'SpeechEmulationCompareFlags', 'SVEAllEvents', 'SSTTDictation',
    'SpeechCategoryAudioIn', 'SPEI_END_INPUT_STREAM',
    'SGRSTTTextBuffer', 'SPAS_STOP', 'DISPID_SVIsUISupported',
    'DISPID_SpeechGrammarRule', 'SPWORD',
    'DISPID_SPPNumberOfElements', 'SpMMAudioOut',
    'ISpeechLexiconPronunciations', 'eLEXTYPE_RESERVED8',
    'SpeechAudioState', 'SSTTWildcard',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SLPLangId',
    'SpeechGrammarWordType', 'ISpMMSysAudio',
    'DISPID_SOTCEnumerateTokens', 'SAFTADPCM_8kHzMono',
    'Speech_StreamPos_Asap', 'SpTextSelectionInformation',
    'SDA_One_Trailing_Space', 'DISPID_SGRSTPropertyName',
    'DISPID_SDKDeleteKey', 'SAFT24kHz16BitStereo',
    'SRTExtendableParse', 'SPRECOGNIZERSTATUS',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SVEWord',
    'SVSFIsFilename', 'DISPID_SVGetAudioInputs',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechGrammarRules',
    'SpStreamFormatConverter', 'DISPID_SLPsCount', 'SVSFParseSsml',
    'SAFTCCITT_uLaw_8kHzMono', 'SPVPRI_ALERT', 'DISPID_SCSBaseStream',
    'DISPID_SOTCategory', 'DISPID_SpeechAudioFormat',
    'ISpeechMMSysAudio', 'SpeechCategoryPhoneConverters',
    'eLEXTYPE_PRIVATE17', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPFM_OPEN_READWRITE', 'SAFTADPCM_44kHzStereo',
    'ISpeechPhraseInfo', 'SPRST_INACTIVE_WITH_PURGE', 'SPVPRIORITY',
    'SPPS_Noun', 'SASClosed', 'eLEXTYPE_PRIVATE7',
    'DISPID_SVEPhoneme', 'DISPID_SRGetPropertyNumber', 'SVEViseme',
    'SPEI_VOICE_CHANGE', 'SPEI_RESERVED3', 'SPAR_Medium',
    'eLEXTYPE_RESERVED10', 'DISPID_SASetState',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechPhraseReplacement',
    'SPWORDPRONUNCIATION', 'SAFT16kHz8BitMono',
    'DISPID_SPEPronunciation', '_ISpeechRecoContextEvents',
    'SPLOADOPTIONS', 'DISPID_SDKGetlongValue',
    'SpeechAudioFormatGUIDText', 'SPGS_EXCLUSIVE',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechRecognizer',
    'DISPID_SGRSTRule', 'SVP_8', 'SAFT32kHz8BitMono', 'SPPS_Verb',
    'SPDKL_CurrentUser', 'SpMemoryStream', 'DISPID_SLWsItem',
    'DISPID_SPCIdToPhone', 'SVSFVoiceMask', 'SpeechAudioFormatType',
    'SPFM_NUM_MODES', 'DISPID_SRCVoicePurgeEvent',
    'SpeechPartOfSpeech', 'DISPID_SRGSetTextSelection',
    'SVEWordBoundary', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SVEStreamStart', 'ISpShortcut', 'SVP_20',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRDisplayUI',
    'DISPID_SABIEventBias', 'DISPID_SLPPhoneIds',
    'DISPID_SOTIsUISupported', '__MIDL_IWinTypes_0009',
    'STCInprocHandler', 'SAFT32kHz16BitStereo', 'DISPID_SGRsDynamic',
    'SAFT48kHz8BitStereo', 'SITooSlow', 'SGDisplay',
    'DISPIDSPTSI_SelectionLength', 'SASRun', 'SPEI_REQUEST_UI',
    'DISPID_SPACommit', 'eLEXTYPE_MORPHOLOGY', 'ISpNotifySink',
    'SPPS_NotOverriden', 'tagSPPROPERTYINFO', 'SPEI_PHONEME',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechObjectToken',
    'SPPS_Noncontent', 'DISPID_SOTGetDescription',
    'SAFTADPCM_11kHzStereo', 'SPRECORESULTTIMES', 'SPSHT_EMAIL',
    'DISPID_SMSADeviceId', 'ISpeechVoice', 'SVF_None',
    'DISPID_SRRAudioFormat', 'ISpeechRecoResult2',
    'SDA_Consume_Leading_Spaces', 'SPSLMA',
    'DISPID_SpeechGrammarRuleStateTransition', 'SWTAdded', 'UINT_PTR',
    'DISPID_SWFEFormatTag', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_SR_PRIVATE', 'SPVISEMES', 'DISPID_SpeechPhraseElement',
    'SPEI_MAX_SR', 'DISPID_SRCRetainedAudioFormat',
    'SVEStartInputStream', 'SITooQuiet', 'DISPID_SVRate',
    'SAFT44kHz16BitMono', 'DISPID_SpeechAudio', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVStatus', 'SPEI_RESERVED6', 'SPCT_SUB_DICTATION',
    'SpVoice', 'SSFMCreateForWrite', 'DISPID_SRGCmdLoadFromResource',
    'SP_VISEME_13', 'SpeechDictationTopicSpelling', 'SPAO_NONE',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVEAudioLevel',
    'DISPID_SPIAudioSizeTime', 'SpeechVisemeFeature', 'SP_VISEME_17',
    'SAFTGSM610_11kHzMono', 'eLEXTYPE_PRIVATE6', 'ISpRecognizer',
    'SpeechTokenKeyFiles', 'SPEI_SR_RETAINEDAUDIO',
    'SWPUnknownWordPronounceable', 'SpWaveFormatEx', 'SGSDisabled',
    'DISPIDSPTSI', 'ISpeechBaseStream', 'DISPID_SGRSTNextState',
    'DISPID_SGRSRule', 'SPEI_UNDEFINED', 'DISPID_SPIEngineId',
    'DISPID_SPRs_NewEnum', 'SRERecognition',
    'DISPID_SDKSetBinaryValue', 'SpeechTokenKeyUI', 'ISpAudio',
    'SAFT48kHz16BitMono', 'DISPID_SGRSTWeight', 'SVP_7',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFT32kHz16BitMono', 'DISPID_SRGCmdSetRuleState',
    'ISpPhoneticAlphabetConverter', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SLPs_NewEnum', 'DISPID_SVGetProfiles',
    'eLEXTYPE_PRIVATE12', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechRecognizerStatus', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SGRs_NewEnum', 'eLEXTYPE_RESERVED7',
    'ISpNotifyTranslator', 'DISPID_SpeechBaseStream',
    'eLEXTYPE_RESERVED6', 'SPRS_ACTIVE', 'DISPID_SRRSaveToMemory',
    'DISPID_SVAlertBoundary', 'SPWT_PRONUNCIATION',
    'SAFT44kHz8BitMono', 'SPSEMANTICFORMAT', 'ISpeechResourceLoader',
    'SPEI_RESERVED5', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCEPropertyNumberChange', 'SPPS_RESERVED2',
    'SP_VISEME_20', 'SP_VISEME_5', 'SPBINARYGRAMMAR',
    'DISPID_SVPriority', 'DISPID_SpeechRecoResult',
    'SSSPTRelativeToCurrentPosition', 'STCRemoteServer',
    'SPEI_MIN_SR', 'SpeechRuleState', 'SINone',
    'SAFT48kHz16BitStereo', 'SP_VISEME_16', 'SpNullPhoneConverter',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'Speech_Default_Weight',
    'ISpeechVoiceStatus', 'ISpeechPhraseElement',
    'DISPID_SpeechLexiconWord', 'ISpRecoGrammar2', 'SpObjectToken',
    'SRSEIsSpeaking', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTCreateInstance', 'SpeechAllElements',
    'SVSFUnusedFlags', 'SAFTCCITT_uLaw_11kHzMono',
    'SPSHT_NotOverriden', 'SPAUDIOSTATUS', 'DISPID_SGRsCount',
    'SVSFNLPSpeakPunc', 'DISPID_SPIGetDisplayAttributes'
]

_check_version('1.1.14', 1654563385.514688)
